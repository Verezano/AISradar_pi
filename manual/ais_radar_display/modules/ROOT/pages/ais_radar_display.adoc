...
* Source Original: https://github.com/Verezano/AISradar_pi
* Forum:
...
link:https://opencpn.org/wiki/dokuwiki/doku.php?id=opencpn:opencpn_user_manual:plugins:install_and_enable[here]:
